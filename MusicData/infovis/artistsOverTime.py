...
# axis labels
plt.xlabel("Year the career was started (assuming at age 20) or the band was founded", fontsize=12, fontweight='light', fontfamily='sans-serif',loc='left')
plt.ylabel("Count of famous musicians and bands", fontsize=12, fontweight='light', fontfamily='sans-serif')
...
# text elements
fig.text(0.08, 0.95, 'Famous Musicians and Bands over the Last 100 Years', fontsize=15, fontweight='bold', fontfamily='serif')
fig.text(0.08, 0.75, 
...
fig.text(0.2, 0.03, 'Author: Philipp Ackermann, philipp@metason.net;  Data Source: https://music.metason.net/famousArtists.html', fontsize=9, fontfamily='sans-serif', color=color3)


plt.annotate('',
            xy=(1963, 49), xycoords='data',
            xytext=(-80, 94), textcoords='offset points',
            size=20,
            arrowprops=dict(arrowstyle="simple",
                            fc="0.6", ec="none",
                            connectionstyle="arc3,rad=0.3"))

fig.text(0.27,0.19,"Individual Artists", fontweight="bold", fontfamily='serif', fontsize=15, color='white')
fig.text(0.49,0.5,"Music Groups", fontweight="bold", fontfamily='serif', fontsize=15, color='black')

# annotate
plt.annotate("",
            xy =(2000, 30), xycoords ='data',
            xytext =(2020, 30), textcoords ='data',
...
plt.annotate('',
            xy=(2003, 33), xycoords='data',
            xytext=(-20, 42), textcoords='offset points',
            size=20,
            arrowprops=dict(arrowstyle="simple",
                            fc="0.5", ec="none",
                            connectionstyle="arc3,rad=0.3"))
