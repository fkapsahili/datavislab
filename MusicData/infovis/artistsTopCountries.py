...
# title and sub-title
fig.text(0.09, 0.95, 'Top 10 Countries Where Famous Musicians Are Coming From', fontsize=15, fontweight='bold', fontfamily='serif')
fig.text(0.09, 0.91, 'The three most dominant countries highlighted are: United States of America, Great Britain, and Jamaika.', fontsize=12, fontweight='light', fontfamily='serif')
fig.text(0.2, 0.03, 'Author: Philipp Ackermann, philipp@metason.net;  Data Source: https://music.metason.net/famousArtists.html', fontsize=10, fontfamily='sans-serif', color=color3)

# insight text
fig.text(0.375, 0.63, 'Insights', fontsize=12, fontweight='bold', fontfamily='serif')
fig.text(0.375, 0.363, '''
...
# axis labels
plt.xlabel("Country the artist was born or the band was founded", fontsize=12, fontweight='light', fontfamily='sans-serif',loc='left',y=-1.5)
